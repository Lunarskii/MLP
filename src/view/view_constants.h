...
struct MetricsWidgetStyle {
    inline static unsigned int indent = 35;                         ///< Indent from the edge of the widget. Default: 35
    ...
    inline static QColor grid_color = Qt::white;                    ///< Color of the grid. Default: white
